...
GAME_EXTENSIONS = ['tzx', 'tap', 'z80', 'sna', 'dsk', 'trd', 'img', 'mgt', 'rom']
AVAILABILITY_AVAILABLE = 0
AVAILABILITY_DISTRIBUTION_DENIED = 1
AVAILABILITY_DISTRIBUTION_DENIED_STILL_FOR_SALE = 2
AVAILABILITY_MISSING_IN_ACTION = 3
AVAILABILITY_NEVER_RELEASED = 4
AVAILABILITY_RECOVERED = 5
